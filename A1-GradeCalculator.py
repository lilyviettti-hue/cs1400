...
# Date:      01/13/2026
# Course:    CS 1400-001
# Professor: H. James de Saint Germain
#
# Program Purpose:
##   A grader program that asks the user for their name and expected averages for Programming Assignments,
##   Quizzes, and Labs, then hypothesizes course percentages for possible midterm averages (0,20,...,100).
